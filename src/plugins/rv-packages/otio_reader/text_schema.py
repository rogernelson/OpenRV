...
fontSize is in OTIO normalised units (relative to available_image_bounds height).
For 16:9 content: small ≈ 0.15, medium ≈ 0.22, large ≈ 0.33.

All coordinates are in OTIO normalised space (see position_schema.py).
...
class Text(otio.core.SerializableObject):
    ...
    fontSize = otio.core.serializable_field("fontSize", required_type=float, doc="Font size in OTIO normalised units")
